...
<div
    class="flex items-start md:items-center flex-col md:flex-row md:justify-between my-8"
>
    <div>
        <a
            href="{{ route('dashboard') }}"
            class="text-gray-600 flex items-center gap-2 font-semibold"
            ><svg
...
>
    <div
        class="bg-white rounded-lg overflow-hidden border border-gray-300 shadow-sm w-full md:flex-1 md:min-w-xs"
    >
        <div
            class="w-full relative bg-gray-200 h-60 flex items-center justify-center"
        >
            <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
            ...
            <span
                class="h-10 w-10 absolute top-3 left-3 text-2xl flex items-center justify-center font-semibold text-white bg-red-600 rounded-full"
                >1</span
            >
        </div>
        <div class="p-5">
            <h1 class="text-xl font-semibold">Rifal Abdul Ghozali</h1>
            ...
            <div class="w-full flex gap-3 mt-6">
                <a
                    href=""
                    class="flex items-center justify-center gap-4 w-full rounded-lg border border-gray-200 bg-gray-100 py-2"
                    ><svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
