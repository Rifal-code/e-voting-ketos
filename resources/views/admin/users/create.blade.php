@extends('layouts.pages') @section('content')
    <div class="w-lg flex flex-col gap-5 p-5 mx-auto">
        <div class="mx-auto text-center">
            ...
            <h1 class="font-black text-2xl my-2">Tambah User</h1>
            <p class="text-gray-600">
                Tambah user baru untuk voting Kandidat
            </p>
        </div>
        ...
        <form action="{{ route('admin.users.store') }}" method="POST"
            ...
            @csrf
            <div>
                <h1 class="font-black text-xl my-2">Tambah User Baru</h1>
                <p class="text-gray-600">Isi data diri User</p>
            </div>
            ...
            <div>
                ...
                <select name="role" class="w-full bg-[#FAFAFA] p-2 border border-gray-200 rounded-md">
                    <option value="" disabled selected>Pilih Role</option>
                    <option value="voter">Siswa</option>
